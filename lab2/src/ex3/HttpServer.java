    ...
    public void run(){
        while(alive){
            ...
            try{
                ...
                new ProcesRequest(ss.accept(),iniContext); ///ProcesRequest tip fir de executie care preia ca paramatru obiectul socket returnat de metoda accept
    ...
    public void run(){
        try{
            ...
            if(request.lastIndexOf("GET")==0)
                fileName = interpretGET(request); //daca cererea e de tip get se trimite catre client resursa solicitata
            else

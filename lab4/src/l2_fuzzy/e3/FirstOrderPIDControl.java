...
import l2_fuzzy.e2.FirtsOrderSystemThreaded;
...
// se introduce referinta
        ...
        for (int i = 0; i < 200; i++) {
            ...
            input.put(p4InpCmd, userCommandInDriver.fuzzifie(command)); //preia valoarea referintei de la operator
            input.put(p2InpSys, plantInDriver.fuzzifie(plant.curentStatus())); //preia de la instalatie valoarea iesirii

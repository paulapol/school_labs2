...
//construim tabela1 FLRS pentru inversor, prima iesire
        ...
        nlLine.put(FuzzyValue.NL, FuzzyValue.PL); // si pe coloana NL avem val PL
        nlLine.put(FuzzyValue.NM, FuzzyValue.PL); // coloana NM avem PL
...
//construim tabela2 FLRS pentru inversor, a doua iesire
        ...
        generalLine.put(FuzzyValue.NL, FuzzyValue.PL); //pentru coloana NL avem PL
        ...
        ruleTable2.put(FuzzyValue.PL, generalLine); //pentru linia PL luam de mai sus coloana si rezultatul (PL,NL)->PL

...
public class SimpelMain {
    ...
    public static void main(String[] args) {
        ...
        OutsideReferenceCalculator orcController= new OutsideReferenceCalculator(tankController, SIM_PERIOD);
        ...
        double waterRefTemp = 48;   //double waterRefTemp = 55; pt exercitiul 3 ; timp in min=7, avg consum=0.09
        ...
        for (int i = 0; i < scenario.getScenarioLength(); i++) {
            ...
            orcController.setInput(scenario.getOutSideTemepratue(i));
            try {Thread.sleep(10);
        ...
        MainView windowORController = FuzzyPVizualzer.visualize(orcController.getNet(), orcController.getRecorder());
        ...
        windowORController.addInteractivePanel("TempLogs", plotterTemperatureLog.makeInteractivePlot());
        windowORController.addInteractivePanel("ComandLogs", plotterCommandLog.makeInteractivePlot());
